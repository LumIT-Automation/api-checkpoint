...
# The checkpointConfig class is in the checkpoint/apps.py file, so its dotted path is 'checkpoint.apps.checkpointConfig'
...
MIDDLEWARE = [
    ...
    'checkpoint.middleware.Log.LogMiddleware',
    'checkpoint.middleware.HTTP.HTTPMiddleware',
]
...
#        'NAME': '/var/lib/sqlite/checkpoint.db',
#    }
#}
...
MAX_REQUESTS = 50 # max number of POST request to the asset in a python loop.

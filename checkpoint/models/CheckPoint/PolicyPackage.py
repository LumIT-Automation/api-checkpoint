...
from checkpoint.models.CheckPoint.backend.PolicyPackage import PolicyPackage as Backend
...
class PolicyPackage:
    ...
    @staticmethod
    def listNatRules(sessionId: str, assetId: int, domain: str, policyPackageUid: str, localOnly: bool = False) -> List[dict]:
        out = list()
        ...
        try:
            if localOnly:
                ...
                out = Backend.listRules(sessionId, assetId, domain, policyPackageUid)
        except Exception as e:
            raise e
    ...
    @staticmethod
    def addNatRule(sessionId: str, assetId: int, domain: str, policyPackageUid: str, data: dict, autoPublish: bool = True) -> dict:
        try:
            return Backend.addNatRule(sessionId, assetId, domain, policyPackageUid, data, autoPublish)
        except Exception as e:
            raise e

...
from checkpoint.models.Permission.repository.Role import Role as Repository
from checkpoint.models.Permission.repository.RolePrivilege import RolePrivilege as RolePrivilegeRepository
